fn main() {
    windows::build!(
        ...
        Windows::Win32::System::Threading::{GetCurrentProcess,GetCurrentThread,PROCESS_BASIC_INFORMATION,PEB,PEB_LDR_DATA},
        ...
        Windows::Win32::System::WindowsProgramming::{PUBLIC_OBJECT_TYPE_INFORMATION,OBJECT_ATTRIBUTES,IO_STATUS_BLOCK,CLIENT_ID,LDR_DATA_TABLE_ENTRY},
